...
exampleIDs(PosExampleIDsInUseOrd, NegExampleIDsInUseOrd):-
  ...
  list_to_ord_set(PosExampleIDsInUse, PosExampleIDsInUseOrd),
  list_to_ord_set(NegExampleIDsInUse, NegExampleIDsInUseOrd).
...
exampleIDs(Fold, PosExampleIDsFold, NegExampleIDsFold, PosExampleIDsNonFold, NegExampleIDsNonFold):-
  setting(sample, Sample),
  findall(PosID, (example(PosID, _Ex, Weight, Fold, Rand), Rand=<Sample, Weight>0), PosExampleIDsFoldUO),
  findall(NegID, (example(NegID, _Ex, Weight, Fold, Rand), Rand=<Sample, Weight<0), NegExampleIDsFoldUO),
  findall(PosID,
  ...
  findall(NegID,
          ...
          NegExampleIDsNonFoldUO),
  list_to_ord_set(PosExampleIDsNonFoldUO, PosExampleIDsNonFold),
  list_to_ord_set(NegExampleIDsNonFoldUO, NegExampleIDsNonFold),
  list_to_ord_set(PosExampleIDsFoldUO, PosExampleIDsFold),
  list_to_ord_set(NegExampleIDsFoldUO, NegExampleIDsFold).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
invertExamples([H|T]) :- 
      example(H, Example, Weight, Fold, Rand),
      NW is -Weight,
      retract(example(H, Example, Weight, Fold, Rand)),
      assert(example(H, Example, NW, Fold, Rand)),
      invertExamples(T).
