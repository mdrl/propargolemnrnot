...
%% %%%%% Added by Miha Drole %%%%%%%
%% clause_examples_coverage(ExampleIDs, Clause, _ClauseSig, MAWC, AFWC, CoveredExampleIDs):-
%%   setting(clause_evaluation, theta_subsumption_neg),!,
%%   theta_subsumes_exampleids_neg(Clause, ExampleIDs, MAWC, AFWC, CoveredExampleIDs).
%% %%%%% END %%%%%%%%%%%
...
%  ((var(ClauseSig);setting(clause_evaluation, left_to_right)) ->
  ((setting(clause_evaluation, left_to_right)) ->
