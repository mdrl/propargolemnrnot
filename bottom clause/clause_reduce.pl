...
positive_clause_reduce_list(ARMG, [], ARMG).

positive_clause_reduce_list(ARMG, [E|OE], NARMG) :-
    positive_clause_reduce(ARMG, E, TARMG),
    positive_clause_reduce_list(TARMG, OE, NARMG).
