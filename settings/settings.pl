...
:- asserta(setting(useneg, true)).
:- asserta(setting(max_neg_depth, 0)).
:- asserta(setting(enumerable_constants, false)).
:- asserta(setting(cws_after_nbr, true)).
:- asserta(setting(par_n_sat, 2)). 
:- asserta(setting(par_clp, false)).
